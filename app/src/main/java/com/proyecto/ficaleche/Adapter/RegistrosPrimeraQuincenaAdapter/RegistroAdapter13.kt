package com.proyecto.ficaleche.Adapter.RegistrosPrimeraQuincenaAdapter
...
class RegistroAdapter13 (
    private val RegistroLista: ArrayList<RegistrosModel13>
)
    : RecyclerView.Adapter<RegistroAdapter13.ViewHolder>(){
